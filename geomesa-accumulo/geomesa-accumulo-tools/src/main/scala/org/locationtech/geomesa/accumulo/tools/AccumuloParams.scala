...
import org.locationtech.geomesa.tools.{CatalogParam, KerberosParams, OptionalCredentialsParams}
...
trait AccumuloConnectionParams extends InstanceNameParams with OptionalCredentialsParams with KerberosParams {
